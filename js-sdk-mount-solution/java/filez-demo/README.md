...
java -jar target/filez-demo-1.0.0.RELEASE.jar \
  ...
  --zoffice.service.app.secret=default-salt \
...
export ZOFFICE_APP_SECRET=default-salt
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| `GET` | `/v2/context/openDoc` | Open document page online |
...
- Check `zoffice.service.app.secret` configuration is consistent with the ZOffice server configuration
