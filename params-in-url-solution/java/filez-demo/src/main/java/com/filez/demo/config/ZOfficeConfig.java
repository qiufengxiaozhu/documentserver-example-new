...
public class ZOfficeConfig {
     ...
     */
    @ApiModelProperty(value = "Context path", example = "/docs/app/driver-callback")
    ...
    public static class App {
        ...
        @ApiModelProperty(value = "Frontend integration configuration")
        private FeIntegration feIntegration;

        @Data
        @Component
        @ConfigurationProperties(prefix = "zoffice.service.app.fe-integration")
        @ApiModel(description = "Frontend integration configuration")
        public static class FeIntegration {

            @ApiModelProperty(value = "Whether to enable frontend integration", example = "true")
